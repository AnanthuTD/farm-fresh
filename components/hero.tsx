    ...
    <section className="relative bg-gradient-to-br from-card to-background py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-bebas-neue text-4xl md:text-6xl font-bold text-foreground mb-6 text-balance">
            Live Fresh
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 text-pretty">
            Premium quality chicken, fish, and beef delivered fresh to your
            doorstep
          </p>
